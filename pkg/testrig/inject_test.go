...
func TestInjectIntoEnv_PanicsOnParallelTest(t *testing.T) {
	t.Run("inner", func(t *testing.T) {
		...
		defer func() {
			r := recover()
			if r == nil {
				t.Fatal("Expected panic from InjectIntoEnv on parallel test")
			}
			msg, ok := r.(string)
		...
		testrig.InjectIntoEnv(t, testrig.Properties{"KEY": "value"})
	})
}

func TestInjectIntoEnv_SetsValues(t *testing.T) {
	key := "TESTRIG_INJECT_TEST_SET"

	t.Run("inner", func(t *testing.T) {
		testrig.InjectIntoEnv(t, testrig.Properties{key: "injected"})
...
func TestInjectIntoEnv_RestoresOriginal(t *testing.T) {
	key := "TESTRIG_INJECT_TEST_RESTORE"
	t.Setenv(key, "original")

	t.Run("inner", func(t *testing.T) {
		testrig.InjectIntoEnv(t, testrig.Properties{key: "overridden"})
...
func TestInjectIntoEnv_UnsetsNewKeys(t *testing.T) {
	key := "TESTRIG_INJECT_TEST_NEW"

	t.Run("inner", func(t *testing.T) {
		testrig.InjectIntoEnv(t, testrig.Properties{key: "new-value"})
...
func TestInjectIntoEnv_EmptyProperties(t *testing.T) {
	testrig.InjectIntoEnv(t, testrig.Properties{})
}

func TestInjectIntoEnv_NilProperties(t *testing.T) {
	testrig.InjectIntoEnv(t, nil)
}

func TestInjectIntoEnv_MultipleKeys(t *testing.T) {
	keys := []string{
