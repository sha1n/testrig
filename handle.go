...
// envHandle is the internal *Env-backed implementation of EnvHandle, with
// a fixed service name so Logger() can return a service-scoped child.
...
func (h *envHandle) Properties() Properties { return h.env.Properties() }
